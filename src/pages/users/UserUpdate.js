  ...
  const updateUser = async () => {
    ...
    try {
      if (!userId) {
        ...
        navigate("/admin-tdi"); // Si l'utilisateur n'est pas authentifié, redirige vers la page de connexion
        return;
      }
      ...
      if (response.ok) {
        ...
        navigate("/admin-tdi/utilisateurs"); // Redirige vers la liste des utilisateurs après la mise à jour
      } else {
