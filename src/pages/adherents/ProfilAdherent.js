...
import { fetchWithToken } from "../../utils/fetchWithToken2"; // assure-toi d'avoir cette fonction
...
const ProfilAdherent = () => {
  ...
  const storedAdherent = JSON.parse(localStorage.getItem("adherent-info"));
